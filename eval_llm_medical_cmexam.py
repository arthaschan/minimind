...
def main():
    ...
    parser.add_argument('--weight', default='full_sft_medical', type=str, help="权重名称前缀（pretrain, full_sft, rlhf, reason, ppo_actor, grpo, spo）")
    parser.add_argument('--lora_weight', default='lora_huatuo_dental_sft_train', type=str, help="LoRA权重名称（None表示不使用，可选：lora_identity, lora_medical）")
