...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_name", type=str, default="lora_huatuo_dental_sft_train", help="LoRA权重名称(如lora_identity/lora_medical等)")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/lora_huatuo_dental_sft_train.jsonl", help="LoRA训练数据路径")
    parser.add_argument('--from_weight', default='full_sft_medical', type=str, help="基于哪个权重训练，默认full_sft")
    parser.add_argument('--from_resume', default=0, type=int, choices=[0, 1], help="是否自动检测&续训（0=否，1=是）")
    parser.add_argument("--use_wandb", action="store_true", help="是否使用wandb")
    parser.add_argument("--wandb_project", type=str, default="medical", help="wandb项目名")
