...
DEFAULT_CONFIG = {
    ...
    "checkpoint_path": "./out/full_sft_medical_512.pth",  # 微调权重文件
    "lora_checkpoint_path": "./out/lora/lora_huatuo_dental_sft_train_512.pth",  # LoRA权重（可选）
    "test_data_path": "./dataset/dental/dental_sft_test.jsonl",
        ...
        for line_num, line in enumerate(f, 1):
            ...
            try:
                ...
                if not isinstance(conversations, list):
                    print("⚠️  conversations字段不是列表格式")
                    return result
        
                # 4. 遍历列表，匹配role提取对应content
                for item in conversations:
                    # 容错：确保item是字典，且包含role和content字段
